...
Feature: Validating Adactin Book Hotel Page
  ...
  Scenario Outline: Validating adactin book hotel page with valid credentials
    ...
    Examples: 
      ...
      | ashoktr6496 | 5W009A   | Sydney   | Hotel Creek | Standard | 2 - Two  | 2 - Two    | 0 - None   | 24/06/2022 | 26/06/2022 | Helen     | Sterling | England |
  ...
  Scenario Outline: Validating adactin book hotel page without entering any credentials
    ...
    Examples: 
      ...
      | ashoktr6496 | 5W009A   | Sydney   | Hotel Creek | Standard | 2 - Two  | 2 - Two    | 0 - None   | 24/06/2022 | 26/06/2022 |
